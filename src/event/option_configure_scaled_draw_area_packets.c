...
extern const u16 g_option_draw_area_scale_percent[12];
...
void option_configure_scaled_draw_area_packets(u8* packet, const void* source,
    ...
    scale = g_option_draw_area_scale_percent[scale_index];
