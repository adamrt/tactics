...
extern const u16 g_debugchr_draw_area_scale_percent[12];
...
void debugchr_configure_scaled_draw_area_packets(u8* packet, const void* source,
    ...
    scale = g_debugchr_draw_area_scale_percent[scale_index];
