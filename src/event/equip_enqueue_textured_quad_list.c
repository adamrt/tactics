...
typedef struct EquipTexturedQuadDescriptor {
    u8 x;
    u8 y;
    u8 w;
    u8 h;
    u8 u;
    u8 v;
} EquipTexturedQuadDescriptor;

extern u16 g_equip_poly_ft4_count;
extern u8* g_equip_graphics_context;

void equip_enqueue_textured_quad_list(const EquipTexturedQuadDescriptor* quads,
    ...
    do {
        ...
        poly = (POLY_FT4*)(*(u8**)(g_equip_graphics_context + 0x10) + index * sizeof(POLY_FT4));
        ...
        {
            u8* context = g_equip_graphics_context;
