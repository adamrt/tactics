...
extern void world_call_inner_subroutine_on_main_thread(s32 p1, s32 p2, s32 p3, s32 p4);

/* Set the WORLD menu-text callback and dispatch the shared text lookup. */
void battle_world_display_menu_text_entry(s32 p1, s32 p2, s32 p3) {
    g_world_inner_subroutine_callback = world_display_menu_text;
    world_call_inner_subroutine_on_main_thread(p1, p2, p3, 0);
}
