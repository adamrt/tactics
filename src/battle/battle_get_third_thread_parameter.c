 ...
 * (src/world/world_get_third_thread_parameter.c): the loads go through $at
...
/* Return parameter 0x8 (word) of the currently selected event thread record. */
s32 battle_get_third_thread_parameter(void) {
