...
void battle_initialize_menu_primitive_colors_palette_bank_1(u8* menu) {
    s32 index;
    s32 palette_offset;
    MenuLineF2* line;
    ...
    do {
        palette_offset = (g_battle_numeric_display_palette_indices[index] + 16) * 2;
