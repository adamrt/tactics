...
extern u8 g_battle_status_bubble_sprite_display_data[];

battle_sprite_display_data_t* battle_initialize_status_bubble_sprite_display(
    s32 unit_index) {
    s32 part_width;
    s32 part_height;
    s32 part_v;
    ...
    part_height = 0xc;
    part_v = 0xb0;
    display = (battle_sprite_display_data_t*)&g_battle_status_bubble_sprite_display_data[unit_index * 0x440];
