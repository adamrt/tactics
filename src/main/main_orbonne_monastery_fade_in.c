...
extern void main_set_display_draw_new_game(int, int, int, u8, u8, u8);
extern int main_swap_display_area(void* otag);

void main_orbonne_monastery_fade_in(void) {
    ...
    intensity = 248;
    main_set_display_draw_new_game(256, 240, 512, 0, 0, 0);
